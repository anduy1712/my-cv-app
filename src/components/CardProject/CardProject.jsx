...
function CardProject({
  ...
  return (
    <div
      ...
      } bg-white px-4 py-4 rounded-3xl shadow-lg mb-20 max-h-[400px]`}
    >
      <div className=" w-[50%] overflow-hidden rounded-3xl">
        <img
      ...
      <div className="flex flex-col flex-1 text-center mx-20">
        ...
        <div className="flex gap-2 justify-center w-full mb-10">
          {technicalTags.map((tag) => (
            <span className="px-2 py-2 bg-white drop-shadow-lg font-bold">
              {tag}
            </span>
          ))}
        </div>
